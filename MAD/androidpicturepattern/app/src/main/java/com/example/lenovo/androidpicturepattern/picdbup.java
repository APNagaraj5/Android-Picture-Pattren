...
public class picdbup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_picdbup);
        ...
        final String ulcode1 = uidpref.getString("ucode", "");
        ...
        subbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               if(ulcode1.equals(ulcode)){
                if(db.updatelock(uid,ulcode)){

                    Toast.makeText(picdbup.this, "Pattern Updated Successfully", Toast.LENGTH_LONG).show();
                    Intent In = new Intent(picdbup.this, inst4.class);
                    startActivity(In);
                    finish();
                }
                else {
                    Toast.makeText(picdbup.this, ulcode+"Default Pattern(123) taken as New pattern update failed", Toast.LENGTH_LONG).show();
                    Intent In = new Intent(picdbup.this, inst4.class);
                    startActivity(In);
                    finish();
                }}
                else{
                   Toast.makeText(picdbup.this, "Select Pattern again", Toast.LENGTH_LONG).show();
                   Intent In = new Intent(picdbup.this, picturespotselecting.class);
                   startActivity(In);
                   finish();
               }
            }
