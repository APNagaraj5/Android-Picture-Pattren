...
public class picturespotselecting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_picturespotselecting);
        ...
        subbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //code to set lock
               {
                   ...
                   uideditpref.putString("ucode", ulcode);
                   uideditpref.commit();
                    Toast.makeText(picturespotselecting.this, "Confirm Pattern Again", Toast.LENGTH_LONG).show();
                    Intent In = new Intent(picturespotselecting.this, picdbup.class);
                    startActivity(In);
                    finish();
                }
       ...
       img9.setScaleType(ImageView.ScaleType.FIT_XY);
        //Toast.makeText(picturespotselecting.this, "Height: "+sethight, Toast.LENGTH_LONG).show();
